      ...
      <div class="flex h-full items-center py-3 xl:py-0">
        ...
        <div>
          <nuxt-link to="/" class="nuxt-link-active">
            <img 
              src="~/assets/images/text-right.svg" 
              width="124" 
              height="24" 
              alt="Global66" 
              loading="lazy" 
        ...
        <div class="links ml-auto mr-1 hidden items-center gap-6 border-r border-[#9ba9d0] pr-7 xl:flex">
          <div class="items flex gap-6">
            ...
            <div 
              class="relative"
              @mouseenter="showProductos = true"
              @mouseleave="showProductos = false"
            >
              <button 
            ...
            <div 
              class="relative"
              @mouseenter="showBeneficios = true"
              @mouseleave="showBeneficios = false"
            >
              <button 
                class="relative inline-block cursor-pointer font-semibold text-white hover:text-white-dark"
              >
          ...
          <div class="flex country-selector hidden md:!-mr-2 xl:flex">
            ...
            >
              ...
              <transition name="fade">
                ...
                >
                  <button class="flex w-full items-center space-x-4 py-3 px-4 hover:bg-neutral-50 lg:py-2">
        ...
        <div class="ctas ml-auto inline-flex items-center space-x-4 xl:ml-4">
          <div class="flex items-center space-x-3 md:space-x-5">
            ...
            <!-- Burger Menu -->
            <button 
              class="burger-menu xl:hidden"
              @click="mobileMenuOpen = !mobileMenuOpen"
            >
              <img 
                src="/misc/burger-menu-icon-white.svg" 
                width="25" 
                height="18" 
                alt="menu"
              />
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="flex items-center justify-between">
              <nuxt-link to="/" class="-m-1.5 p-1.5">
                <img 
                  src="~/assets/images/iso-default.svg" 
                  width="48" 
                  height="48" 
                  alt="Global66" 
                  loading="lazy" 
                ...
                <div>
                  ...
                  >
                    ...
                    <svg 
                      ...
                      fill="#3F5EDF" 
                      viewBox="0 0 20 20" 
                      class="h-6 w-6 flex-none transition-transform"
                      :class="{ 'rotate-180': showProductosMobile }"
                    >
                      <path 
                        clip-rule="evenodd" 
                ...
                <div>
                  ...
                  >
                    ...
                    <svg 
                      ...
                      viewBox="0 0 20 20" 
                      class="h-6 w-6 flex-none transition-transform"
                      :class="{ 'rotate-180': showBeneficiosMobile }"
                    >
                      <path 
                        clip-rule="evenodd" 
                        d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" 
              ...
              <div class="flex flex-col gap-6 py-6">
                ...
                <div class="flex country-selector">
                  <button class="flex items-center space-x-4 lg:space-x-2">
                    ...
                    <img src="/misc/caret-b2c.svg" width="10" height="8" alt="caret" loading="lazy" class="relative top-px" />
                  </button>
                </div>
